...
def menu():
    ...
    if not username: # check if user already logged in, otherwise show this menu
        username = login_register(prices)
    ...
    if choice == 1:
        ...
        date = input_validator("date",
                               text_style("input",
                                    """Please enter the date for the budget, 
                                       which will be 7 days previous to the date you provide.
        ...
        if username == username_to_delete:
            ans = input_validator("letter",
                                  text_style("input",
                                             f"""Are you sure you want to delete all data belonging to user 
                                             {username_to_delete}
